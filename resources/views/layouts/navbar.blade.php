                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('customer.index') ? 'active' : '' }}" href="{{ route('customer.index') }}">
                            <i class="bi bi-people"></i> Manajemen Nasabah
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('mandatory-saving.index') ? 'active' : '' }}" href="{{ route('mandatory-saving.index') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('investments.index') ? 'active' : '' }}" href="{{ route('investments.index') }}">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            <li>
                                <a class="dropdown-item" href="{{ route('roles.index') }}">
                                    <i class="bi bi-shield-lock"></i> Kelola Peran
                                </a>
                            </li>
                            <li>
